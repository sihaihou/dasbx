 ...
 *
 */
public abstract class AbstractStringRedisSync<T,E extends RedisDocument> extends AbstractRedisFullSync implements RedisIncrementUpdateSync<T, Integer> {
	...
	public AbstractStringRedisSync(RedisUtil redisUtil) {
		super();
