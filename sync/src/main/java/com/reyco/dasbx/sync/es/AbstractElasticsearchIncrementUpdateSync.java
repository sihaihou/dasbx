 ...
 *
 */
public abstract class AbstractElasticsearchIncrementUpdateSync<T,E extends ElasticsearchDocument> implements ElasticsearchIncrementUpdateSync<T,Integer> {

	private static final Logger logger = LoggerFactory.getLogger(AbstractElasticsearchIncrementUpdateSync.class);
	
	protected ElasticsearchClient<ElasticsearchDocument> elasticsearchClient;
	
	public AbstractElasticsearchIncrementUpdateSync(ElasticsearchClient<ElasticsearchDocument> elasticsearchClient) {
		super();
